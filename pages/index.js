...
export default function Home() {
  ...
  // Handle errors
  const handleError = () => {
    setMessages((prevMessages) => [...prevMessages, { role: "assistant", content: "Oops, it looks like my response got cut short. Please try sending your message again and I'll do my best to respond in full. Thank you for your patience!" }]);
    setLoading(false);
    setUserInput("");
  }
  ...
  setAudioUrl(data.audioUrl); // Store the audio URL
  setLoading(false);
};
